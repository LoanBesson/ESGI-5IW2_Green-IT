        ...
        <div class="mt-6">
                    ...
                    <ul class="mt-2">
                        @if ($cities->isNotEmpty())
                            ...
                            @foreach ($cities as $city)
                                <li>- <button wire:click="scoring({{ $city->id }}, 3)">{{ $city->libcom }}</button></li>
                            @endforeach
                            <br>
                        @endif
                        ...
                        @if ($states->isNotEmpty())
                            ...
                            @foreach ($states as $state)
                                <li>- <button wire:click="scoring({{ $state->id }}, 1)">{{ $state->libreg }}</button></li>
                            @endforeach
                            <br>
                        @endif
                    </ul>
            ...
            @if($scoring)
                <div class="w-1/2 mx-auto mt-6 mb-8 ">
                    ...
                    <div class="grid grid-cols-{{ $type }} gap-4 mt-4">
                        @if ($type != 1)
